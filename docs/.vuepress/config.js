    ...
    sidebar: [
      ...
      },
      {
        ...
        children: [
          ...
          { text: "自动浇灌系统*", link: "/第二单元_控制与系统基础/自动浇灌系统.md" },
      ...
      {
        text: "第八单元 人工智能与创新",
        link: "/第八单元_人工智能与创新/人脸识别门禁.md",
        collapsible: true,
        children: [
          { text: "人脸识别门禁*", link: "/第八单元_人工智能与创新/人脸识别门禁.md" },
          { text: "语音合成与播放", link: "/第八单元_人工智能与创新/语音合成与播放.md" },
          { text: "大语言模型交互", link: "/第八单元_人工智能与创新/大语言模型交互.md" }
        ]
      },
      {
        text: "第九单元 跨学科探索",
        link: "/第九单元_跨学科探索/文物存放的适宜环境探究.md",
        collapsible: true,
        children: [
          { text: "文物存放的适宜环境探究*", link: "/第九单元_跨学科探索/文物存放的适宜环境探究.md" },
          { text: "奶牛产奶监测系统", link: "/第九单元_跨学科探索/奶牛产奶监测系统.md" },
          { text: "热水的降温规律*", link: "/第九单元_跨学科探索/热水的降温规律.md" },
          { text: "不同农作物的生长环境探究", link: "/第九单元_跨学科探索/不同农作物的生长环境探究.md" },
        ]
      },
    ],
    sidebarDepth: 0
